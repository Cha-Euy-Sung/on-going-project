...
# ValueError: invalid option string 'HSV': must start with a character '-'
#   if not args['filter'].upper() in ['--RGB', '--HSV']:  -->  KeyError: 'filter'
# range-detector.py: error: argument -f/--HSV: expected one argument

def get_arguments():
    ap = argparse.ArgumentParser()
    ap.add_argument('-f', '--filter', required=True, help='Range filter.HSV')
